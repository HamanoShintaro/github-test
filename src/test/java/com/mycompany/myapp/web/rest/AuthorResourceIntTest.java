...
public class AuthorResourceIntTest {
    ...
    private static final String DEFAULT_PHONETIC_NAME = "AAAAAAAAAA";
    private static final String UPDATED_PHONETIC_NAME = "BBBBBBBBBB";
    ...
    public static Author createEntity(EntityManager em) {
        Author author = new Author()
            .name(DEFAULT_NAME)
            .phoneticName(DEFAULT_PHONETIC_NAME);
        return author;
    }
    ...
    public void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.getPhoneticName()).isEqualTo(DEFAULT_PHONETIC_NAME);
    }
    ...
    public void getAllAuthors() throws Exception {
        ...
        restAuthorMockMvc.perform(get("/api/authors?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].phoneticName").value(hasItem(DEFAULT_PHONETIC_NAME.toString())));
    }
    ...
    public void getAuthor() throws Exception {
        ...
        restAuthorMockMvc.perform(get("/api/authors/{id}", author.getId()))
            ...
            .andExpect(jsonPath("$.phoneticName").value(DEFAULT_PHONETIC_NAME.toString()));
    }
    ...
    public void updateAuthor() throws Exception {
        ...
        updatedAuthor
            .name(UPDATED_NAME)
            .phoneticName(UPDATED_PHONETIC_NAME);
        ...
        assertThat(testAuthor.getPhoneticName()).isEqualTo(UPDATED_PHONETIC_NAME);
    }
